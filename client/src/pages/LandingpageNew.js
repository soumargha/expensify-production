  ...
  return (
    ...
    >
      <div className="relative z-10 flex flex-col items-center">
        ...
        <p className="my-6 max-w-xl text-center text-base leading-relaxed md:text-lg md:leading-relaxed mt-8">
          The personalized Expense management system to track all your daily expenses and incomes.
        </p>
        <motion.div
          animate={{
            scale: [1, 1.2, 1.2, 1, 1],
        ...
        >
          ...
          >
            click here
            <FiArrowRight className="transition-transform group-hover:-rotate-45 group-active:-rotate-12 ml-2" />
          </ScrollLink>
        </motion.div>
      </div>

      {/* Second Section Inside Motion Section */}
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-transparent p-10 pt-28 mt-52 ">
